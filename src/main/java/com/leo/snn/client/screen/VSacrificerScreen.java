package com.leo.snn.client.screen;
...
public class VSacrificerScreen extends AbstractContainerScreen<VSacrificerMenu> {
    ...
    public static ResourceLocation BACKGROUND = new ResourceLocation(SanguineNeuralNetworks.MODID, "textures/gui/vsacrificer_bg.png");
